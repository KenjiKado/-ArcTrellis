...
Run `ArcTrellis-Setup-1.0.0-win-x64.exe`. The installer does not need administrator rights by default. It creates an optional desktop shortcut, registers `.arctrellis` files, and includes an uninstaller in Windows Settings.
